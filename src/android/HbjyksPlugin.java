...
import com.talkweb.hbjyks.PlayerActivity;
...
public class HbjyksPlugin extends CordovaPlugin {
    private static final String LOG_TAG = "HbjyksPlugin";
    ...
    public boolean execute(String action,final JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equalsIgnoreCase(OPEN_ACTION)) { //打开新的页面
            ...
            cordova.getActivity().runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Intent intent = new Intent(_context, PlayerActivity.class);
